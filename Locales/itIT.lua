...
L["other_thanks"] = "Un ringraziamento speciale a ProfitzTV e Testerle per il loro lavoro su LootAppraiser; questo addon si basa fortemente sul loro lavoro. Mi trovo sulle spalle di giganti.\n\nGrazie anche a lordtyrion2005 per aver fornito un aggiornamento per WoW 11.1.x in mia assenza."
L["need_help"] =
...
L["bag"] = "Borsa";
L["bank"] = "Banca";
L["guild_bank"] = "Banca Gilda";
L["total"] = "Totale";
L["based_on"] = "Basato su";
L["bank_last_updated"] = "Banca ultimo aggiornamento";
L["guild_bank_last_updated"] = "Banca Gilda ultimo aggiornamento";
...
L["account_bank"] = "Banca della squadra di guerra";
L["account_bank_last_updated"] = "Ultimo aggiornamento della banca della squadra di guerra";
L["enable_account_bank"] = "Abilita banca della squadra di guerra";
L["enable_account_bank_desc"] = "Riassumi il contenuto della banca della squadra di guerra.";
L["enable_account_bank_footer"] = "Abilitare la banca della squadra di guerra includerà il suo valore ovunque venga visualizzato il 'Totale combinato'. Sebbene il valore della banca della squadra di guerra sia condiviso tra i personaggi, il calcolo non lo è.";
L["feature_tww_support"] = "NUOVO -- BagAppraiser ora supporta The War Within e ha un supporto iniziale per la Banca della squadra di guerra! Si prega di segnalare eventuali problemi riscontrati.";
L["feature_reagent_bag_only"] = "NUOVO - BagAppraiser ora supporta una modalità solo sacche reagenti! Controlla la finestra di configurazione per maggiori dettagli."
L["bag_selection"] = "Selezione Borse"
L["bags_all"] = "Tutte le Borse"
L["bags_reagent"] = "Solo Borse Reagenti"
L["bag_selection_desc"] = "Seleziona quali borse includere nella valutazione. Se impostato su qualsiasi cosa diversa da 'Tutte le Borse', la banca di gilda sarà esclusa poiché Blizzard tratta quegli slot in modo leggermente diverso."
L["bag_selection_changed"] = "Selezione borse cambiata a: %s"
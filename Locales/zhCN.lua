...
L["other_thanks"] = "特别感谢 ProfitzTV 和 Testerle 在 LootAppraiser 上的工作；本插件在很大程度上借鉴了他们的成果。我站在巨人的肩膀上。\n\n同时感谢 lordtyrion2005 在我缺席期间为 WoW 11.1.x 提供更新。"
...
L["feature_reagent_bag_only"] = "新增 - BagAppraiser 现在支持仅材料袋模式！请查看配置窗口了解更多详情。"
L["bag_selection"] = "包选择"
L["bags_all"] = "所有包"
L["bags_reagent"] = "仅材料袋"
L["bag_selection_desc"] = "选择要包含在估价中的包。如果设置为“所有包”以外的任何内容，则将排除公会银行，因为暴雪对这些插槽的处理方式略有不同。"
L["bag_selection_changed"] = "包选择已更改为：%s"
...
L["no_price_sources"] =
"|cffff0000Achtung!|r Fehlende zusätzliche Addons für Preisquellen (z.B. TradeSkillMaster oder The Undermine Journal).\n\n|cffff0000BagAppraiser deaktiviert.|r";
...
L["other_thanks"] =
"Besonderer Dank an ProfitzTV und Testerle für ihre Arbeit an LootAppraiser; dieses Addon stützt sich stark auf ihre Arbeit. Ich stehe auf den Schultern von Riesen.";
L["need_help"] =

...
L["account_bank"] = "Warband Bank";
L["account_bank_last_updated"] = "Warband bank last updated";
L["enable_account_bank"] = "Enable warband bank"
L["enable_account_bank_desc"] = "Summarize the contents of the warband bank."
L["enable_account_bank_footer"] = "Enabling the warband bank will include its value anywhere the 'Combined Total' is displayed.  While the value of the warband bank is shared amongst characters, the calculation is not."
L["feature_tww_support"] = "NEW -- BagAppraiser now supports The War Within and has initial support for the Warband Bank!  Please report any issues you encounter."
L["feature_reagent_bag_only"] = "NEW - BagAppraiser now supports a reagent bag only mode!  Check the config window for more details."
L["bag_selection"] = "Bag Selection";
L["bags_all"] = "All Bags";
L["bags_reagent"] = "Reagent Bags Only";
L["bag_selection_desc"] = "Select which bags to include in the valuation.  If set to anything other than 'All Bags', the warband bank will be excluded as Blizzard treats those slots slightly differently.";
L["bag_selection_changed"] = "Bag selection changed to: %s";